               ...
               <div class="container-fluid">
                  <div class="header-mobile-inner">
                     <a class="logo" href="{{url('admin/dashboard')}}">
                        <h3><i class="fas fa-shopping-cart mr-2 text-success"></i>{{Config::get('constants.SITE_NAME')}}</h3>
                        <span style="margin-left:100px; font-size: 15px;" class="text-success">Administrator</span>
                     </a>
            ...
            <nav class="navbar-mobile">
               <div class="container-fluid">
                  <ul class="navbar-mobile__list list-unstyled">
                     ...
                     <li class="@yield('department_select')">
                        <a href="{{url('/admin/department')}}">
                        <i class="fas fa-file-alt"></i>Departments</a>
                     </li>
                     <li class="@yield('branch_select')">
                        <a href="{{url('/admin/branch')}}">
                        <i class="fas fa-tags"></i>Branches</a>
                     </li>
                     ...
                     <li class="@yield('question_select')">
                        <a href="{{url('/admin/question')}}">
                        <i class="fas fa-question"></i>Questions</a>
                     </li>
                     <li class="@yield('notice_select')">
                        <a href="{{url('/admin/notice')}}">
                        <i class="fas fa-list"></i>Notices</a>
                     </li>
