                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            ...
                            <a href="{{url('/')}}">
                                <h2><i class="fas fa-graduation-cap mr-2 text-success"></i>{{Config::get('constants.SITE_NAME')}}</h2>
                                <small class="text-success">Student login</small>
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="{{url('/student/auth')}}" method="post">
                                @csrf
